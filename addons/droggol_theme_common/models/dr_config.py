...
class DrThemeConfig(models.Model):
    ...
    def _get_default_theme_config(self, website_id):
        ...
        return {
            ...
            'json_category_pills': {'enable': True, 'enable_child': True, 'hide_desktop': False, 'show_title': True, 'style': '1'},
            'json_grid_product': {'show_color_preview': True, 'show_quick_view': True, 'show_similar_products': True, 'show_rating': True, 'show_stock_label': False, 'style': '2'},
            'json_shop_filters': {'filter_method': 'default', 'in_sidebar': False, 'collapsible': True, 'show_category_count': True, 'show_attrib_count': False, 'hide_extra_attrib_value': False, 'show_rating_filter': True, 'show_availability_filter': False, 'tags_style': '1'},
            ...
            'json_b2b_shop_config': {'dr_enable_b2b': False, 'dr_only_assigned_pricelist': False, 'dr_allow_reorder': False},
            'json_mobile': {},
